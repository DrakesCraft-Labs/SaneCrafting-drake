...
**SaneCrafting-drake** es un port mantenido por DrakesCraft Labs de un addon creado por otras personas.
Se publica al amparo de su licencia **MIT**, que permite redistribuir y modificar siempre que
...
MIT. El texto completo esta en el fichero LICENSE de este repositorio.
